...
public class RecommendationRestController {
    ...
    public List<Book> recommendSimilarBooks(@PathVariable("id") String id) {
        try {
            return recommendationService.recommendSimilarProducts(id).stream().map(BookMapper.INSTANCE::from).peek(setTitleAuthorAndGenre()).peek(setRating()).collect(Collectors.toList());
    ...
    @java.beans.ConstructorProperties({"recommendationService", "bookService", "ratingService"})
    @Autowired
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public RecommendationRestController(final RecommendationService recommendationService, final BookService bookService, final RatingService ratingService) {
